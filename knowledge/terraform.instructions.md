...
- Don't use `tflint` or other linters that enforce stylistic rules beyond the official Terraform Style Guide, as they may conflict with these conventions.

## Documentation

- Extend README.md if necessary to explain the purpose and usage of the Terraform configurations.
